  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchExpenses.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload?.message || "No se pudieron cargar los gastos";
      })
      ...
      .addCase(updateExpense.rejected, (state, action) => {
        state.saving = false;
        state.error = action.payload?.message || "No se pudo actualizar el gasto";
        state.validationErrors = action.payload?.errors || [];
      })
      ...
      .addCase(deleteExpense.rejected, (state, action) => {
        state.deleting = false;
        state.error = action.payload?.message || "No se pudo eliminar el gasto";
      });
  }
});
